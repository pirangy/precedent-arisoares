...
import { useTypeScriptModal } from "@/components/home/tech-modals/typescript-modal"

export default function TypeScript({ className }: { className?: string }) {
    const { TypeScriptModal, setShowTypeScriptModal } = useTypeScriptModal();

    return(
        <div>
            <TypeScriptModal />
            <button onClick={() => setShowTypeScriptModal(true)}>
