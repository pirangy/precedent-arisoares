...
import { useAngularModal } from "@/components/home/tech-modals/angular-modal"


export default function Angular({ className }: { className?: string }) {
    const { AngularModal, setShowAngularModal } = useAngularModal();
    return(
        <div>
            <AngularModal />
            <button onClick={() => setShowAngularModal(true)}>
