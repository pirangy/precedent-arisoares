...
import { useSpringModal } from "@/components/home/tech-modals/spring-modal"

export default function SpringBoot({ className }: { className?: string }) {
    const { SpringModal, setShowSpringModal } = useSpringModal();

    return(
        <div>
            <SpringModal />
            <button onClick={() => setShowSpringModal(true)}>
